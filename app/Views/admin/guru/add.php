<div class="row">
    <div class="col-12">
        ...
        <p class="lead">Isi formulir di bawah untuk menambahkan data guru pembimbing baru.</p>
    </div>
</div>
    ...
    <div class="col-lg-8">
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <?= form_open(base_url('dashboard/admin/saveGuru')) ?>
                    <?= csrf_field() ?>

                    <div class="mb-3">
                        <label for="nip" class="form-label">NIP (Nomor Induk Pegawai)</label>
                        <input type="text" class="form-control rounded-pill <?= $validation->hasError('nip') ? 'is-invalid' : '' ?>" id="nip" name="nip" value="<?= old('nip') ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control rounded-pill <?= $validation->hasError('nama_guru') ? 'is-invalid' : '' ?>" id="nama_guru" name="nama_guru" value="<?= old('nama_guru') ?>" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control rounded-pill <?= $validation->hasError('bidang_keahlian') ? 'is-invalid' : '' ?>" id="bidang_keahlian" name="bidang_keahlian" value="<?= old('bidang_keahlian') ?>" placeholder="Contoh: RPL, TKJ">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control rounded-pill <?= $validation->hasError('no_hp_guru') ? 'is-invalid' : '' ?>" id="no_hp_guru" name="no_hp_guru" value="<?= old('no_hp_guru') ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control rounded-pill <?= $validation->hasError('email_guru') ? 'is-invalid' : '' ?>" id="email_guru" name="email_guru" value="<?= old('email_guru') ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select rounded-pill <?= $validation->hasError('id_user') ? 'is-invalid' : '' ?>" id="id_user" name="id_user">
                            ...
                            <?php foreach ($usersList as $userItem): ?>
                                <option value="<?= esc($userItem->id_user) ?>" <?= old('id_user') == $userItem->id_user ? 'selected' : '' ?>>
                    ...
                    <div class="d-grid mt-4">
                        <button type="submit" class="btn btn-primary btn-lg rounded-pill">Simpan Data Guru</button>
